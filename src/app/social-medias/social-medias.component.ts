...
export class SocialMediasComponent implements OnInit {
  ...
  validateSocialMediasForm() {
    ...
    const telegramAddressValidate = document.getElementById("telegram").value;
    ...
    const instagramAddressValidate = document.getElementById("instagram").value;
    // const addressPattern = /^(?:http(s)?:\/\/)?[\w.-]+(?:\.[\w\.-]+)+[\w\-\._~:/?#[\]@!\$&'\(\)\*\+,;=.]+$/;
    ...
    const websiteAddressValidate = document.getElementById("website").value;
    // const addressPattern = /^(?:http(s)?:\/\/)?[\w.-]+(?:\.[\w\.-]+)+[\w\-\._~:/?#[\]@!\$&'\(\)\*\+,;=.]+$/;
